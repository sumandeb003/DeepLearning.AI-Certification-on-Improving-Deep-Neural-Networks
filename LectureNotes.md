...
The derivaitve at a point on a multi-dimensional cost function $J(\theta_1, \theta_2, \theta_3,....\theta_i,...\theta_n)$ w.r.t $\theta_i$ is approximated as: $\frac{J(\theta_1, \theta_2, \theta_3,....\theta_i+\epsilon,...\theta_n) - J(\theta_1, \theta_2, \theta_3,....\theta_i-\epsilon,...\theta_n)}{2\epsilon}$
