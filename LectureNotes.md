...
The derivaitve of a multi-dimensional cost function $J(\theta_1, \theta_2, \theta_3,....\theta_i,...\theta_n)$ w.r.t $\theta_i$ w.r.t a parameter $\theta_i$ at a training point is approximated as: $\frac{\partial J}{\partial \theta_i}$ = $\frac{J(\theta_1, \theta_2, \theta_3,....\theta_i+\epsilon,...\theta_n) - J(\theta_1, \theta_2, \theta_3,....\theta_i-\epsilon,...\theta_n)}{2\epsilon}$
